...
class _ProfileViewState extends State<ProfileView> implements ProfileViewContract {
  ...
  final List<String> allergyOptions = ["Gluten",
    "Pollen",
    "Dust",
    "Nut",
    "Milk",
  ...
  void initState() {
    ...
    _presenter.loadProfile(); // optional: to check if a profile exists
  }
  ...
  void showProfile(Profile profile, String? avatarUrl) {
    setState(() {
      ...
      selectedAllergies = profile.allergyTypes;
    });
  }
  ...
  void _onSaveProfile() async {
    final profile = Profile(
      ...
      lastName: _lastName,
      skinType: _skinType,
      allergyTypes: selectedAllergies,
      age: _age,
    );
  ...
  Widget build(BuildContext context) {
    if (_profileData != null) {
      return ProfileSummaryView(profile: _profileData!, avatarUrl: _avatarUrl);
    }
          ...
          child: MouseRegion(
            ...
            child: Stack(
              ...
              children: [
                ...
                CircleAvatar(
                  radius: 58,
                  backgroundColor: AppColors.Hover2, // always visible
                  child: ClipOval(
                ...
                // Hover overlay (semi-transparent background + icon)
                AnimatedOpacity(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      color: AppColors.Hover2.withOpacity(0.8), // semi-transparent
                    ),
                    child: Center(
  ...
  Widget _card({required Widget child}) => Container(
    ...
    decoration: BoxDecoration(
      ...
      border: Border.all(
        color: AppColors.greyLight.withOpacity(0.2), // 👈 same opacity as textfield
        width: 1,
      ),
    ),
    child: child,
